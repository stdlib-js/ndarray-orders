...
```javascript
import orders from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-orders@v0.1.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { enum } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-orders@v0.1.1-esm/index.mjs';
```
